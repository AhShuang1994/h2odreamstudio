...
> 状态：**规划中，尚未开发**。此文件只记录从 3 张参考图提取的可用元素、合并方案、以及本地化（马来西亚 Johor Bahru）需求，供决策用。
...
1. **视觉方向** — 上面三选一？还是混搭？
2. **页面数量** — 单页 Landing（快、便宜）vs 多页站（首页 / 服务 / 价格 / 团队 / 相册 / 关于 / 联络，SEO 强）？
...
7. **先做 demo 还是先做完整站** — 建议先出一版首页 demo 放 `demos/`，确认方向后再展开。

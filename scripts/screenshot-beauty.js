...
(async () => {
  const pagePath = 'file:///' + path.resolve(__dirname, '../demos/glowseoul-skincare.html').replace(/\\/g, '/');
  ...
  await desktopPage.screenshot({
    path: path.join(outDir, 'landing-beauty-desktop.png'),
    type: 'png',
    fullPage: false
  });
  ...
  await mobilePage.screenshot({
    path: path.join(outDir, 'landing-beauty-mobile.png'),
    type: 'png',
    fullPage: false
  });
